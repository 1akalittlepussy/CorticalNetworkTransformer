...
class DiffGraphTransformer(nn.Module):
    ...
    def __init__(self, in_size, nb_class, d_model, nb_heads,
        ...
        self.embedding_sp_pos_enc = nn.Linear(in_size, d_model)
    ...
    def forward(self, x, adj, masks, pe, x_lap_pos_enc=None, degree=None, spatial_pe=None):
        ...
        x = x.permute(1, 0, 2)
        #spatial_pe=self.embedding_sp_pos_enc(spatial_pe)
        output = self.embedding(x)
       #output = output+spatial_pe.permute(1, 0, 2)
