...
def main(args):
 ...
 n_tags = None
    #dataset = FSDataset(r'..\ROISignals_FunImgARCWF',folds=10,seed=1)
 ...
 for i in range(10):
    ...
    if args.pos_enc is not None:
        ...
        if pos_encoding_method is not None:
            ...
            pos_cache_path = 'F:/graphmix-master-new/cache/pe9/{}_{}_{}.pkl'.format(args.pos_enc, args.normalization, pos_encoding_params_str)
...
if __name__ == "__main__":
    ...
    result_file = os.path.join(save_root, f"result4.log")
    trial_file = os.path.join(save_root, f"result4.trial")
