...
class Network(torch.nn.Module):
    def __init__(self, indim, ratio, nclass, k=8, R=62):
        '''
        ...
        self.bn3= torch.nn.BatchNorm1d(self.indim)
        self.bn4 = torch.nn.BatchNorm1d(self.dim1)
        self.bn5 = torch.nn.BatchNorm1d(self.dim2)
    ...
    def forward(self, data, *args, **kwargs):
        ...
        size=batch.size()
        pos = torch.ones(x.size(0),x.size(1),device=edge_index.device)
